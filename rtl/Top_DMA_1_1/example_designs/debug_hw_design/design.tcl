...
proc create_ipi_design { offsetfile design_name } {
	...
	set Top_DMA_0 [ create_bd_cell -type ip -vlnv user.org:user:Top_DMA:1.1 Top_DMA_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:Top_DMA:1.1]]]]
